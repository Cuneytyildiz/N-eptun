...
public class MainActivity extends AppCompatActivity {
    ...
    public void tanimla(){
        ...
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(MainActivity.this,2); // Bir Satırda 2 Kullanıcı Gözüksün
    ...
    public void listele(){
        reference.child("Kullanıcılar").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                if(!dataSnapshot.getKey().equals(userName)){ // Kullanıcı rehberde kendini görmez
